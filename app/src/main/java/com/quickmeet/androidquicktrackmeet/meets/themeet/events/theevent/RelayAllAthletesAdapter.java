...
public class RelayAllAthletesAdapter extends RecyclerView.Adapter<RelayAllAthletesAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (Meet.canManage || AppData.mySchool.equalsIgnoreCase(schoolAthletes.get(getAdapterPosition()).getSchoolFull())) {
                ...
                else if (relayAdapter.relayEvent.getRelayMembers().size()>=4){
                    return;
                }
